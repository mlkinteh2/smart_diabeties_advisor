...
<div class="dashboard-container">
    ...
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li>
                <a href="{% url 'prediction_list' %}" class="sidebar-link {% if request.resolver_match.url_name == 'prediction_list' %}active{% endif %}">
            ...
            <li>
                <a href="{% url 'role_selection' %}" class="sidebar-link {% if request.resolver_match.url_name == 'role_selection' %}active{% endif %}">
